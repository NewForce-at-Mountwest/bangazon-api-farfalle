...
//        public async Task<TrainingProgram> createChickenMonkey(HttpClient client)
//        {
//            TrainingProgram howToCode = new TrainingProgram
//            {
...
//                MaxAttendees = 14
//            };
//            string howToCodeAsJSON = JsonConvert.SerializeObject(howToCode);


//            HttpResponseMessage response = await client.PostAsync(
//                "api/trainingprogram",
//                new StringContent(howToCodeAsJSON, Encoding.UTF8, "application/json")
//            );

//            response.EnsureSuccessStatusCode();

//            string responseBody = await response.Content.ReadAsStringAsync();
//            TrainingProgram howToCode = JsonConvert.DeserializeObject<Customer>(responseBody);
